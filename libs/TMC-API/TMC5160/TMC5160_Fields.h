...
#define TMC5160_RECALIBRATE_MASK                      0x01U // GCONF //Zero crossing recalibration during driver disable (via DRV_ENN or via TOFF setting)
#define TMC5160_RECALIBRATE_SHIFT                     0U // min.: 0, max.: 1, default: 0
#define TMC5160_FASTSTANDSTILL_MASK                   0x02U // GCONF // Timeout for step execution until standstill detection
#define TMC5160_FASTSTANDSTILL_SHIFT                  1U // min.: 0, max.: 1, default: 0
#define TMC5160_EN_PWM_MODE_MASK                      0x04U // GCONF //
#define TMC5160_EN_PWM_MODE_SHIFT                     2U // min.: 0, max.: 1, default: 0
#define TMC5160_MULTISTEP_FILT_MASK                   0x08U // GCONF //
#define TMC5160_MULTISTEP_FILT_SHIFT                  3U // min.: 0, max.: 1, default: 0
#define TMC5160_SHAFT_MASK                            0x10U // GCONF //
#define TMC5160_SHAFT_SHIFT                           4U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG0_ERROR_ONLY_WITH_SD_MODE1_MASK   0x20U // GCONF //
#define TMC5160_DIAG0_ERROR_ONLY_WITH_SD_MODE1_SHIFT  5U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG0_OTPW_ONLY_WITH_SD_MODE1_MASK    0x40U // GCONF //
#define TMC5160_DIAG0_OTPW_ONLY_WITH_SD_MODE1_SHIFT   6U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG0_STALL_MASK                      0x80U // GCONF //
#define TMC5160_DIAG0_STALL_SHIFT                     7U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG1_STALL_MASK                      0x0100U // GCONF //
#define TMC5160_DIAG1_STALL_SHIFT                     8U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG1_INDEX_MASK                      0x0200U // GCONF //
#define TMC5160_DIAG1_INDEX_SHIFT                     9U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG1_ONSTATE_MASK                    0x0400U // GCONF //
#define TMC5160_DIAG1_ONSTATE_SHIFT                   10U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG1_STEPS_SKIPPED_MASK              0x0800U // GCONF //
#define TMC5160_DIAG1_STEPS_SKIPPED_SHIFT             11U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG0_INT_PUSHPULL_MASK               0x1000U // GCONF //
#define TMC5160_DIAG0_INT_PUSHPULL_SHIFT              12U // min.: 0, max.: 1, default: 0
#define TMC5160_DIAG1_POSCOMP_PUSHPULL_MASK           0x2000U // GCONF //
#define TMC5160_DIAG1_POSCOMP_PUSHPULL_SHIFT          13U // min.: 0, max.: 1, default: 0
#define TMC5160_SMALL_HYSTERESIS_MASK                 0x4000U // GCONF //
#define TMC5160_SMALL_HYSTERESIS_SHIFT                14U // min.: 0, max.: 1, default: 0
#define TMC5160_STOP_ENABLE_MASK                      0x8000U // GCONF //
#define TMC5160_STOP_ENABLE_SHIFT                     15U // min.: 0, max.: 1, default: 0
#define TMC5160_DIRECT_MODE_MASK                      0x010000U // GCONF //
#define TMC5160_DIRECT_MODE_SHIFT                     16U // min.: 0, max.: 1, default: 0
#define TMC5160_TEST_MODE_MASK                        0x020000U // GCONF //
#define TMC5160_TEST_MODE_SHIFT                       17U // min.: 0, max.: 1, default: 0
...
//#define TMC5160__SHIFT                              0 // min.: -128, max.: 127, default: 0
#define TMC5160_IHOLD_MASK                            0x1FU // IHOLD_IRUN // Standstill current (0=1/32...31=32/32) In combination with stealthChop mode, setting IHOLD=0 allows to choose freewheeling or coil short circuit (passive braking) for motor stand still.
#define TMC5160_IHOLD_SHIFT                           0U // min.: 0, max.: 31, default: 0
#define TMC5160_IRUN_MASK                             0x1F00U // IHOLD_IRUN // Motor run current (0=1/32...31=32/32) Hint: Choose sense resistors in a way, that normal IRUN is 16 to 31 for best microstep performance.
#define TMC5160_IRUN_SHIFT                            8U // min.: 0, max.: 31, default: 0
#define TMC5160_IHOLDDELAY_MASK                       0x0F0000U // IHOLD_IRUN // Controls the number of clock cycles for motor power down after standstill is detected (stst=1) and TPOWERDOWN has expired. The smooth transition avoids a motor jerk upon power down. 0:  instant power down 1..15:  Delay per current reduction step in multiple of 2^18 clocks
#define TMC5160_IHOLDDELAY_SHIFT                      16U // min.: 0, max.: 15, default: 0
#define TMC5160_TPOWERDOWN_MASK                       0xFFU // TPOWERDOWN // (Reset default=20) Sets the delay time from stand still (stst) detection to motor current power down. Time range is about 0 to 5.6 seconds. 0...((2^8)-1) * 2^18 tclk Attention: A minimum setting of 2 is required to allow automatic tuning of stealthChop PWM_OFFS_AUTO.
#define TMC5160_TPOWERDOWN_SHIFT                      0U // min.: 0, max.: 255, default: 0
...
#define TMC5160_TSTEP_SHIFT                           0U // min.: 0, max.: 1048575, default: 0
...
#define TMC5160_TPWMTHRS_SHIFT                        0U // min.: 0, max.: 1048575, default: 0
...
//#define TMC5160_TOFF_MASK                             0x0FU // CHOPCONF // off time and driver enable
//#define TMC5160_TOFF_SHIFT                            0U // min.: 0, max.: 15, default: 0
//#define TMC5160_TFD_ALL_MASK                          0x70U // CHOPCONF // fast decay time setting
//#define TMC5160_TFD_ALL_SHIFT                         4U // min.: 0, max.: 7, default: 0
//#define TMC5160_OFFSET_MASK                           0x0780U // CHOPCONF // sine wave offset
//#define TMC5160_OFFSET_SHIFT                          7U // min.: 0, max.: 15, default: 0
#define TMC5160_TFD_3_MASK                            0x0800U // CHOPCONF // MSB of fast decay time setting
#define TMC5160_TFD_3_SHIFT                           11U // min.: 0, max.: 1, default: 0
#define TMC5160_DISFDCC_MASK                          0x1000U // CHOPCONF // fast decay mode
#define TMC5160_DISFDCC_SHIFT                         12U // min.: 0, max.: 1, default: 0
#define TMC5160_CHM_MASK                              0x4000U // CHOPCONF // chopper mode
#define TMC5160_CHM_SHIFT                             14U // min.: 0, max.: 1, default: 0
#define TMC5160_TBL_MASK                              0x018000U // CHOPCONF // blank time select
#define TMC5160_TBL_SHIFT                             15U // min.: 0, max.: 3, default: 0
//#define TMC5160_VHIGHFS_MASK                          0x040000U // CHOPCONF // high velocity fullstep selection
//#define TMC5160_VHIGHFS_SHIFT                         18U // min.: 0, max.: 1, default: 0
//#define TMC5160_VHIGHCHM_MASK                         0x080000U // CHOPCONF // high velocity chopper mode
//#define TMC5160_VHIGHCHM_SHIFT                        19U // min.: 0, max.: 1, default: 0
//#define TMC5160_TPFD_MASK                             0xF00000U // CHOPCONF // Passive fast decay time TPFD allows dampening of motor mid-range resonances. Passive fast decay time setting controls duration of the fast decay phase inserted after bridge polarity change N CLK = 12 + 256*TPFD %0000: Disable %0001 ... %1111: 1 ... 15
//#define TMC5160_TPFD_SHIFT                            20U // min.: 0, max.: 15, default: 0
//#define TMC5160_MRES_MASK                             0x0F000000U // CHOPCONF // Micro step resolution; The resolution gives the number of microstep entries per sine quarter wave. The driver automatically uses microstep positions which result in a symmetrical wave, when choosing a lower microstep resolution.
//#define TMC5160_MRES_SHIFT                            24U // min.: 0, max.: 8, default: 0
//#define TMC5160_INTPOL_MASK                           0x10000000U // CHOPCONF // interpolation to 256 microsteps
//#define TMC5160_INTPOL_SHIFT                          28U // min.: 0, max.: 1, default: 0
//#define TMC5160_DEDGE_MASK                            0x20000000U // CHOPCONF // enable double edge step pulses
//#define TMC5160_DEDGE_SHIFT                           29U // min.: 0, max.: 1, default: 0
//#define TMC5160_DISS2G_MASK                           0x40000000U // CHOPCONF // short to GND protection disable
//#define TMC5160_DISS2G_SHIFT                          30U // min.: 0, max.: 1, default: 0
//#define TMC5160_DISS2VS_MASK                          0x80000000U // CHOPCONF // short to supply protection disable
//#define TMC5160_DISS2VS_SHIFT                         31U // min.: 0, max.: 1, default: 0
//#define TMC5160_TOFF_MASK                             0x0FU // CHOPCONF // off time and driver enable
//#define TMC5160_TOFF_SHIFT                            0U // min.: 0, max.: 15, default: 0
//#define TMC5160_TFD_ALL_MASK                          0x70U // CHOPCONF // fast decay time setting
//#define TMC5160_TFD_ALL_SHIFT                         4U // min.: 0, max.: 7, default: 0
...
//#define TMC5160_DISFDCC_MASK                          0x1000U // CHOPCONF // fast decay mode
//#define TMC5160_DISFDCC_SHIFT                         12U // min.: 0, max.: 1, default: 0
//#define TMC5160_RNDTF_MASK                            0x2000U // CHOPCONF // random TOFF time
//#define TMC5160_RNDTF_SHIFT                           13U // min.: 0, max.: 1, default: 0
//#define TMC5160_CHM_MASK                              0x4000U // CHOPCONF // chopper mode
//#define TMC5160_CHM_SHIFT                             14U // min.: 0, max.: 1, default: 0
//#define TMC5160_TBL_MASK                              0x018000U // CHOPCONF // blank time select
//#define TMC5160_TBL_SHIFT                             15U // min.: 0, max.: 3, default: 0
//#define TMC5160_VSENSE_MASK                           0x020000U // CHOPCONF // sense resistor voltage based current scaling
//#define TMC5160_VSENSE_SHIFT                          17U // min.: 0, max.: 1, default: 0
//#define TMC5160_VHIGHFS_MASK                          0x040000U // CHOPCONF // high velocity fullstep selection
//#define TMC5160_VHIGHFS_SHIFT                         18U // min.: 0, max.: 1, default: 0
//#define TMC5160_VHIGHCHM_MASK                         0x080000U // CHOPCONF // high velocity chopper mode
//#define TMC5160_VHIGHCHM_SHIFT                        19U // min.: 0, max.: 1, default: 0
...
#define TMC5160_TOFF_MASK                             0x0FU // CHOPCONF // off time and driver enable
#define TMC5160_TOFF_SHIFT                            0U // min.: 0, max.: 15, default: 0
#define TMC5160_HSTRT_MASK                            0x70U // CHOPCONF // hysteresis start value added to HEND; Attention: Effective HEND+HSTRT less than or equal to 16. Hint: Hysteresis decrement is done each 16 clocks
#define TMC5160_HSTRT_SHIFT                           4U // min.: 0, max.: 7, default: 0
#define TMC5160_HEND_MASK                             0x0780U // CHOPCONF // hysteresis low value
#define TMC5160_HEND_SHIFT                            7U // min.: 0, max.: 15, default: 0
//#define TMC5160_CHM_MASK                              0x4000U // CHOPCONF // chopper mode
//#define TMC5160_CHM_SHIFT                             14U // min.: 0, max.: 1, default: 0
//#define TMC5160_TBL_MASK                              0x018000U // CHOPCONF // blank time select
//#define TMC5160_TBL_SHIFT                             15U // min.: 0, max.: 3, default: 0
...
#define TMC5160_DISS2VS_MASK                          0x80000000U // CHOPCONF // short to supply protection disable
#define TMC5160_DISS2VS_SHIFT                         31U // min.: 0, max.: 1, default: 0
#define TMC5160_SEMIN_MASK                            0x0FU // COOLCONF // minimum stallGuard2 value - If the stallGuard2 result falls below SEMIN*32, the motor current becomes increased to reduce motor load angle. 0: smart current control coolStep off
